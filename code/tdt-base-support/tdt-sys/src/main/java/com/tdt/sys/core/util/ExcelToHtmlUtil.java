...
public class ExcelToHtmlUtil {
    ...
    public static String returnExcelToHtml(Workbook wb, boolean isWithStyle) {
        String htmlExcel = null;
        if (wb instanceof XSSFWorkbook) {   //03版excel处理方法
            XSSFWorkbook xWb = (XSSFWorkbook) wb;
            htmlExcel = ExcelToHtmlUtil.getExcelInfo(xWb, isWithStyle);
...
//            short alignment = cellStyle.getAlignment();
            ...
            if (wb instanceof XSSFWorkbook) {
                ...
                sb.append(getBorderStyle(palette, 0, cellStyle.getTopBorderColor(), cellStyle.getTopBorderColor()));
