...
//     * @throws Exception
//     */
//    public List<List<Object>> read(int sheetIx) throws Exception {
...
//     * @throws Exception
//     */
//    public List<List<Object>> read(int sheetIx, int start, int end) throws Exception {
...
//        style.setAlignment(style.getAlignmentEnum().CENTER);// 内容居中
//
//        //style.setBorderTop(style.getBorderBottomEnum().THIN);// 边框样式
...
//            //style.setFillPattern(style.getFillPatternEnum().NO_FILL);// 填充方式
//            font.setBold(true);
...
//     *
//     */
//    public Object getValueAt(int sheetIx, int rowIndex, int colIndex) {
//        Sheet sheet = workbook.getSheetAt(sheetIx);
...
//     * @return
//     */
//    public List<Object> getRowValue(int sheetIx, int rowIndex) {
//        Sheet sheet = workbook.getSheetAt(sheetIx);
//        Row row = sheet.getRow(rowIndex);
...
//     * @return
//     */
//    public List<Object> getColumnValue(int sheetIx, int rowIndex, int colIndex) {
//        Sheet sheet = workbook.getSheetAt(sheetIx);
//        List<Object> list = new ArrayList<Object>();
...
//     *
//     */
//    private Object getCellValueToString(Cell cell) {
//    	Object value = null;
