layui.use(['table', 'ax', 'func'], function () {
    ...
    Supplier.search = function () {
        ...
        queryData['pid'] = Feng.getUrlParam("pid");
    ...
    Supplier.openAddDlg = function () {
        func.open({
            title: '添加',
            content: Feng.ctxPath + '/element/add?type='+Feng.getUrlParam("type") + "&pid="+ Feng.getUrlParam("pid"),
    ...
    */
    ...
    var tableResult = table.render({
        ...
        height: "full-158",
        cellMinWidth: 100,
        where:{type:$("#elementType").val(),type:Feng.getUrlParam("type"),pid:Feng.getUrlParam("pid")},
